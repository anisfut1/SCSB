 ...
 * session valide. Destinée aux layouts/pages protégés. Le middleware protège
 * déjà ces routes en amont (voir src/middleware.ts) ; cet appel est la
 * seconde barrière côté serveur, pas un simple confort d'UI.
 */
