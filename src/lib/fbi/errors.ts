/**
 * Erreurs et statuts FBI partagés entre `HttpFbiClient` (ce module) et
 * `BrowserFbiClient` (worker/src/fbi/browser-client.ts — copie volontairement
 * indépendante, voir worker/README.md "Pourquoi dupliquer").
 */
